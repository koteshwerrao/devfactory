...
6)Download the file click the download link  the file will be stores our application folder (or) click on the file name also it will  be download our application folder.
